...
def get_active_exchanges(cur):
    """
    SCALABILITY FIX: 
    Fetch the list of exchanges from the DB instead of hardcoding.
    """
    cur.execute("SELECT exchange_code FROM ref.exchange WHERE is_active = TRUE")
        ...
        with get_db_connection() as conn:
            with conn.cursor() as cur:
                ...
                if all_instruments_to_upsert:
                    ...
                    execute_batch(cur, query, all_instruments_to_upsert)
